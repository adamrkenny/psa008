...
ggplot(data.frame(x = c(-1.0, 1.0)), aes(x = x)) +
  ...
  scale_colour_brewer(palette = "Dark2",
   ...
   theme_classic()
```
Figure \@ref(fig:rq1-plot) shows the power obtained for RQ1. We achieve power >90% for all combinations of effect size and slope variance when K ≥ 50. At N = 200, we achieve power >95% when the slope variance is ≤ 0.02 and K ≥ 40.
...
Figure \@ref(fig:rq2-plot) shows the power obtained for RQ2. We achieve power >90% for all combinations of effect size and slope variance when K ≥ 50 and beta ≥ 0.1. At N = 200, we achieve power >95% when the slope variance is ≤ 0.02 and K ≥ 40.
