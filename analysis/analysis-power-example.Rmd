...
simulation_swarm_rq1 <- function(n_ids = 200, n_countries = 40, beta = 0.19, random_intercept = 1.5, random_slope) {
    ...
    ## YD: this makeLmer gives a theta size mismactch, 3 != 4, indicating that we needed to pass one more value for VarCorr
...
parameter_space_rq3 <-
    ...
    crossing(
        random_slope = c(0.1, 0.5, 1.0) # for "self-esteem in country" random slope
    )
