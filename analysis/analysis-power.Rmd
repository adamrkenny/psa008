...
```{r, package-information, class.source = 'fold-hide'}
...
The smallest correlation coefficient we can detect is `r = rq2-country-pwr$r`.
...
Warning, the code below will zap cpu! best to run the code above which is an example using a single set of parameters
