...
This document describes the power analysis for PSA 008 Minimal Groups. It is split into two parts. 
...
## iteratively create datasets that vary in the number of countries
...
The output for RQ1 is generated by the following iterative code. We initially examined power for participant samples of 100 to 400 in steps of 50 but given that power asymptoted at lower sample sisze we here present results for samples of 100 to 250 ins teps of 50.
...
parameter_space_rq3 <-
    ...
    crossing(
        n_ids = c(100, 150, 200, 250), # number of participants per country
        n_countries = c(20, 30, 40, 50, 60), # number of countries
        beta = c(0.10, 0.25, 0.40), # beta for "MGE" 
...
plot_power_rq3 <- 
  ...
  geom_hline(yintercept = 0.95, linetype = 2) +
  ylim(0.70, 1.00) +
  facet_wrap(beta_MGE ~ random,
             scales = "free_x",
             labeller = labeller(random = as_labeller(
                                       c("0.3" = "random intercept = 0.3",
                                         "0.9" = "random intercept = 0.9",
                                         "1.5" = "random intercept = 1.5"
                                         )),
                                   beta_MGE = as_labeller(
                                      c("0.1" = "effect of MGE = 0.10",
                                         "0.25" = "effect of MGE = 0.25",
                                          "0.4" = "effect of MGE = 0.40"
                                    )))
               ) +
    scale_colour_brewer(palette = "Dark2",
                        name = "number of\ncountries",
...
## create plot
## YD: does not run, column names issue; AK: still?
plot_power <-
